...
module.exports = function(homebridge) {
  ...
  homebridge.registerPlatform("homebridge-samplePlatform3", "SamplePlatform", SamplePlatform, true);
}
...
function SamplePlatform(log, config, api) {
  ...
  this.requestServer.listen(18084, function() {
...
SamplePlatform.prototype.addAccessory = function(accessoryName) {
  ...
  newAccessory.addService(Service.Lightbulb, "回家模式")
  .getCharacteristic(Characteristic.On)
  .on('set', function(value, callback) {
    platform.log(accessory.displayName, "Light -> " + value);
    callback();
  ...
  this.api.registerPlatformAccessories("homebridge-samplePlatform3", "SamplePlatform", [newAccessory]);
}
...
SamplePlatform.prototype.removeAccessory = function() {
  ...
  this.api.unregisterPlatformAccessories("homebridge-samplePlatform3", "SamplePlatform", this.accessories);
...
function startScene() {
    ...
    var scene_ID_openall = 12;
    var sceneID = scene_ID_openall;
